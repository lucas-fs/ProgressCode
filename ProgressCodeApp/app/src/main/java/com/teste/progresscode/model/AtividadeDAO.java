...
public class AtividadeDAO {
    ...
    public AtividadeDAO(Context context){ dbHelper = new DbSQLiteHelper(context); }
    ...
    public void insertAtividade(Atividade atividade){
        ...
        values.put("encontro_id", atividade.getIdEncontro());
    ...
    public List<Atividade> getAllAtividades(){
        ...
        Cursor cursor = database.query("atividades", new String[] {"id", "descricao", "encontro_id"}, null, null, null, null, null);
